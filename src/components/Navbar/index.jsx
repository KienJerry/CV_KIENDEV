...
export default ({ nav, lang }) => {
  ...
  const handleDownload = () => {
    const fileUrl = '/img/cert/CV.pdf';
    const link = document.createElement('a');
    link.href = fileUrl;
    link.download = 'CV_NGUYEN_THE_KIEN.pdf';
    link.click();
  };
  ...
  return (
    <nav>
      <ul className={style.nav}>
        ...
        <li className="Navbar_list__wLmGI" style={{padding:'5px 20px'}}>
          <div className={style.current} onClick={() => handleDownload()}>
